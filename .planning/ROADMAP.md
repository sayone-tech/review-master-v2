...
- [x] **Phase 13: Action Items and Notifications** — Action Items module, manual creation, status workflow, notification bell (completed 2026-05-04)
...
**Plans**: 15 plans (13 original + 2 gap closure)
  - [x] 11-01-PLAN.md — Review/AuditLog models + Shop GBP fields + factories + django-filter (SYNC-04..06, SYNC-10, REVW-13, REVW-14)
  - [x] 11-02-PLAN.md — Google Reviews API client (list_reviews + post_reply) (SYNC-07..09)
  - [x] 11-03-PLAN.md — Sync service: fetch_and_persist + run_initial_backfill + Redis progress + token bucket (SYNC-03..07, SYNC-09..10, PROG-10)
  - [x] 11-04-PLAN.md — Celery tasks + Beat seed migration for incremental fan-out (SYNC-01, SYNC-02, SYNC-08, SYNC-10)
  - [x] 11-05-PLAN.md — SyncProgressConsumer staff-scope tightening + Redis snapshot reader (PROG-08, PROG-09)
  - [x] 11-06-PLAN.md — ReviewViewSet + filters + selectors + cursor pagination + REVW-14 query-count test (REVW-01..05, REVW-14)
  - [x] 11-07-PLAN.md — Reply service + endpoint + ScopedRateThrottle + AuditLog (REVW-09, REVW-10, REVW-12, REVW-13)
  - [x] 11-08-PLAN.md — Shop create dispatches initial_backfill + /shops/syncing/ endpoint + GBP resource names (SYNC-01, PROG-01, PROG-06)
  - [x] 11-09-PLAN.md — Frontend foundation: types + api + useReviews hook + template + Vite entry (REVW-01, REVW-03..05, REVW-11)
  - [x] 11-10-PLAN.md — Reviews list UI: ReviewTable + filters + badges + empty states (REVW-02..08, REVW-11)
  - [x] 11-11-PLAN.md — Inline ReplyComposer accordion (REVW-09, REVW-10, REVW-12)
  - [x] 11-12-PLAN.md — ProgressModal + OAuth->modal trigger on Shops page (PROG-01..05, PROG-08, PROG-09)
  - [x] 11-13-PLAN.md — TopbarSyncIndicator widget + topbar partial + Vite entry (PROG-03, PROG-06, PROG-07, PROG-08)
  - [x] 11-14-PLAN.md — Gap closure: token_bucket_depleted gate + review.fetched AuditLog (SYNC-09, SYNC-10)
  - [x] 11-15-PLAN.md — Gap closure: Review.tags field + tag chip rendering scaffolding (REVW-07)
...
| 13. Action Items and Notifications | 8/8 | Complete   | 2026-05-04 | - |
